...
def solve(grid):
    ...
    for v in grid[c]:                       # Iterate over all the values (1t/m9) in grid[c] --> a cell example A1
        if no_conflict(grid, c, v):         # can only move on if the value is a valid acction
            #Alternatief --> new_grid = grid.copy() // new_grid[c] = v // if solve(new_grid): //return True
            grid[c] = v                     # overwrite the previous value of a given position with the new value
            if solve(grid):                 # recursive call
                return True                 # found a solution
            grid[c] = '123456789'           # undo assignment
...
def is_solved(grid):
    ...
    for v in grid.values():
        if len(v) != 1:
            # if a cell has more than one value, the problem is not solved
            return False
    # if all cells have only one value that means the sudoku is solved
    return True
...
'''grid = {'A1': '123456789', 'A2': '5', 'A3': '6', 'A4': '123456789', 'A5': '1', 'A6': '123456789', 'A7': '3', 'A8': '123456789', 'A9': '123456789',
        'B1': '123456789', 'B2': '123456789', 'B3': '1', 'B4': '6', 'B5': '123456789', 'B6': '123456789', 'B7': '123456789', 'B8': '123456789', 'B9': '5',
        'C1': '8', 'C2': '9', 'C3': '123456789', 'C4': '123456789', 'C5': '123456789', 'C6': '7', 'C7': '123456789', 'C8': '123456789', 'C9': '4',
        'D1': '123456789', 'D2': '8', 'D3': '123456789', 'D4': '1', 'D5': '123456789', 'D6': '4', 'D7': '5', 'D8': '123456789', 'D9': '123456789',
        'E1': '2', 'E2': '123456789', 'E3': '123456789', 'E4': '123456789', 'E5': '123456789', 'E6': '123456789', 'E7': '123456789', 'E8': '123456789', 'E9': '1',
        'F1': '123456789', 'F2': '123456789', 'F3': '4', 'F4': '2', 'F5': '123456789', 'F6': '5', 'F7': '123456789', 'F8': '9', 'F9': '123456789',
        'G1': '1', 'G2': '123456789', 'G3': '123456789', 'G4': '4', 'G5': '123456789', 'G6': '123456789', 'G7': '123456789', 'G8': '8', 'G9': '9',
        'H1': '9', 'H2': '123456789', 'H3': '123456789', 'H4': '123456789', 'H5': '123456789', 'H6': '1', 'H7': '6', 'H8': '123456789', 'H9': '123456789',
        'I1': '123456789', 'I2': '123456789', 'I3': '3', 'I4': '123456789', 'I5': '6', 'I6': '123456789', 'I7': '4', 'I8': '1', 'I9': '123456789'}
'''
#solve(grid)
